            <div style="padding-bottom: 50px">
                ...
                <ul>
                    <li>Просмотреть список всех пользователей </li>
                    <li>Редактировать данные пользователя: изменить имя, фамилию, телефон, email, активировать, изменить группу пользователя</li>
